#/Users/gsethi2409/Desktop/kaggle/input/
...
def getImageNames():
    image_names = []
    for dirname, _, filenames in os.walk('/Users/gsethi2409/Desktop/kaggle/input'):
...
def get_path(image_name):
    ...
    home_path = '/Users/gsethi2409/Desktop/kaggle/input/medical-masks-dataset/'
...
while(cap.isOpened()):
    ...
    if ret == True:
        ...
        for (x, y, w, h) in faces:
            ...
            if prediction == 0:
                cv2.putText(frame, "Wearing a Mask", (x,y - 10), font, font_scale, green, thickness)
                cv2.rectangle(frame, (x, y), (x+w, y+h), blue, 2)
            elif prediction == 1:
                cv2.putText(frame, "Not Wearing a Mask!", (x,y - 10), font, font_scale, red, thickness)
